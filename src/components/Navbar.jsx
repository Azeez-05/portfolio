    ...
    <nav className='fixed top-0 w-full z-40 bg-[rgba(10,10,10,0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg'>
        <div className='max-w-5xl mx-auto px-4 py-2'>
            <div className='flex justify-between items-center h-16'>
                <a href="#home" className='text-xl font-bold text-white font-mono'>Abdulazeez<span className='text-violet-800'>.Dev</span></a>
                ...
                <div className='hidden md:flex items-center space-x-8'>
                    ...
                    <a href="#social" className='text-gray-300 hover:text-white transition duration-300'>Contact</a>
                </div>
            </div>
